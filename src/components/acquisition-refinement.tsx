...
export function AcquisitionRefinement({
  ...
  return (
    <div className="acquisition-stage">
      <AcquisitionJourneyOrientation current="preview" />
      <section
      ...
      >
        ...
        <div className="acquisition-conversation-question">
          <p className="eyebrow">Refine this setup</p>
          <h2 id="acquisition-refinement-title">
            What should work differently in your preview?
          </h2>
          <p className="acquisition-refinement-guidance">
            Describe the outcome you want. Lenni will update this same
            candidate, not start an ongoing chat.
          </p>
          {refinementsRemaining > 0 ? (
            <form action={refineAcquisitionAction} className="acquisition-form">
              ...
              <PendingSubmitButton
                ...
                pendingLabel="Updating your preview…"
            ...
            <p className="muted">
              ...
              session. Return to the current preview or start a new proposal.
            </p>
          )}
        ...
        <p className="acquisition-conversation-limit">
          ...
          {refinementsRemaining === 1 ? "" : "s"} remaining in this bounded
