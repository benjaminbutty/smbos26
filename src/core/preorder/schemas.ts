...
const orderMappingsSchema = z
  .object({
    ...
    collection_local_display: graphKeySchema,
    collection_timezone: graphKeySchema,
  ...
  .superRefine((config, context) => {
    const mappedFieldGroups = [
      ...
      [
        ...
        config.field_mappings.order.collection_local_display,
        config.field_mappings.order.collection_timezone,
