...
export const BUILDER_PREORDER_AMENDMENT_INSTRUCTION = [
  ...
  "For a new question, return exactly one add_preorder_question amendment with the requested owner-facing label, help_text, requested public requiredness, and answer_style exactly short_answer or long_answer.",
  "For a new question, set help_text to null when the owner did not explicitly supply or request help text; use a bounded string only when the owner explicitly supplied or requested help text.",
