...
const safeMessages: Readonly<Record<AiExecutionErrorCode, string>> = {
  ...
  ai_refused: "The AI service declined this request.",
  ai_incomplete: "The AI service could not complete the response.",
  ai_content_filtered: "The AI service could not safely return a response.",
